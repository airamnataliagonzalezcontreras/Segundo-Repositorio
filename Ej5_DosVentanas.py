# airam natalia
# programacion 3°B  
# dos ventanas con nombre y mensaje 
...
def abrir_ventana_nombre():
    ...
    etiqueta_nombre = tk.Label(ventana_nombre, text="Nombre: airam natalia", font=("Arial", 12))
    etiqueta_nombre.pack(pady=5)
    etiqueta_apellidos = tk.Label(ventana_nombre, text="Apellidos: gonzalez contreras", font=("Arial", 12))
